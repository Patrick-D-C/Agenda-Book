...
Para o desenvolver o projeto foi utilizado as ferramentas mais recentes do mercado, focado em Restful, Vite.js como construtor ( Larevel 9 + Inertia.JS + React), Tailwind + MUI como base de estilos e banco de dados MySQL.


## Objetivo

Tinha como proposito desenvolver uma agenda a onde fosse possivel cadastrar varias pessoas e gerir seus contatos de forma simples e rapida. 
